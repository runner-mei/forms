...
func init() {
	...
	dir19 := &embedded.EmbeddedDir{
		...
		DirModTime: time.Unix(1516107542, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			file1a, // with_button/options/select.html
	...
	dir1b := &embedded.EmbeddedDir{
		...
		DirModTime: time.Unix(1516107542, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			file1c, // with_button/text/textinput.html
	...
	dir18.ChildDirs = []*embedded.EmbeddedDir{
		dir19, // with_button/options
		dir1b, // with_button/text
	...
	embedded.RegisterEmbeddedBox(`templates`, &embedded.EmbeddedBox{
		...
		Dirs: map[string]*embedded.EmbeddedDir{
			...
			"default/text":        dir13,
			"with_button":         dir18,
			"with_button/options": dir19,
			"with_button/text":    dir1b,
		},
		Files: map[string]*embedded.EmbeddedFile{
			...
			"with_button/options/select.html":     file1a,
			"with_button/text/textinput.html":     file1c,
		},
	})
}
